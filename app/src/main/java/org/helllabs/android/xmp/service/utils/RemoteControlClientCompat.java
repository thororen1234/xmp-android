...
public class RemoteControlClientCompat {
        ...
        try {
            ...
            for (Field field : RemoteControlClientCompat.class.getFields()) {
                try {
                    ...
                    Timber.w("Could not get real field: %s", field.getName());
                } catch (IllegalArgumentException | IllegalAccessException e) {
                    Timber.w("Error trying to pull field value for: %s %s", field.getName(), e.getMessage());
                }
            }
    ...
    public RemoteControlClientCompat(PendingIntent pendingIntent, Looper looper) {
        ...
        try {
            ...
            Timber.e(e, "Error creating new instance of %s", sRemoteControlClientClass.getName());
        }
    }
